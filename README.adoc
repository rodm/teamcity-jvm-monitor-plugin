...
:uri-download: https://github.com/rodm/teamcity-jvm-monitor-plugin/releases/latest
:uri-version: https://img.shields.io/github/v/release/rodm/teamcity-jvm-monitor-plugin?label=TeamCity%20plugin
:uri-downloads: https://img.shields.io/github/downloads/rodm/teamcity-jvm-monitor-plugin/total?label=Downloads
