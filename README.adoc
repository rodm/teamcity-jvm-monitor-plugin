...
* Download and install a TeamCity server run `./gradlew installTeamCity2025.03`
* Deploy the plugin run `./gradlew deployPlugin2025.03`
* Start the server run `./gradlew startTeamcity2025.03`
* To stop the server run `./gradlew stopTeamcity2025.03`

== Compatibility

The plugin is compatible with TeamCity 2025.03 and later and requires the build agent to be running on Java 21 or later.
